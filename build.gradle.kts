...
spotless {
    java {
        target(
                ...
                "src/main/java/com/mewcode/agent/ToolPolicy.java",
                "src/main/java/com/mewcode/config/AgentConfig.java",
                "src/main/java/com/mewcode/config/SubAgentConfig.java",
                "src/main/java/com/mewcode/definition/**/*.java",
                ...
                "src/main/java/com/mewcode/tool/impl/LoadSkillTool.java",
                "src/main/java/com/mewcode/tool/impl/AgentTool.java",
                "src/main/java/com/mewcode/tool/impl/TaskTools.java",
                "src/main/java/com/mewcode/subagent/**/*.java",
                "src/main/java/com/mewcode/skill/**/*.java",
                ...
                "src/main/java/com/mewcode/config/HookConfigLoader.java",
                ...
                "src/main/java/com/mewcode/agent/PromptAdditions.java",
                "src/main/java/com/mewcode/session/SessionManager.java",
                "src/main/java/com/mewcode/hook/**/*.java",
                ...
                "src/test/java/com/mewcode/MewCodeTest.java",
                ...
                "src/test/java/com/mewcode/agent/AgentTurnCoordinatorHookTest.java",
                "src/test/java/com/mewcode/agent/AgentTurnCoordinatorSkillTest.java",
                ...
                "src/test/java/com/mewcode/agent/ToolPolicyTest.java",
                ...
                "src/test/java/com/mewcode/tool/impl/LoadSkillToolTest.java",
                "src/test/java/com/mewcode/tool/impl/AgentToolTest.java",
                "src/test/java/com/mewcode/tool/impl/TaskToolsTest.java",
                "src/test/java/com/mewcode/skill/**/*.java",
                "src/test/java/com/mewcode/definition/**/*.java",
                "src/test/java/com/mewcode/subagent/**/*.java",
                ...
                "src/test/java/com/mewcode/hook/**/*.java",
