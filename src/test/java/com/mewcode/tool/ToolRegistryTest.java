...
class ToolRegistryTest {
    ...
    void toolResultMetadataIsAnImmutableLocalSnapshot() {
        ...
        assertThrows(UnsupportedOperationException.class,
                () -> result.metadata().put("extra", true));
    }
    ...
    private record StubTool(String name, ToolCategory category) implements Tool {
        ...
        @Override
        public boolean isReadOnly() { return category == ToolCategory.FILE; }

        @Override
        public boolean isDestructive() { return category == ToolCategory.SHELL; }
